...
public class BoardDAO {
	...
	public int getListCount(String items, String text) {
		...
		try {
			...
			System.out.println("getListCount() 예외처리 : " + ex);
		} finally {			
			try {				
				if (rs != null) 
					rs.close();							
	...
	public void insertBoard(BoardDTO board)  {		
		...
		try {
			...
			System.out.println("insertBoard() 예외처리 : " + ex);
		} finally {
			try {									
				if (pstmt != null) 
					pstmt.close();				
	...
	public void updateHit(int num) {
		...
		try {
			...
			System.out.println("updateHit() 예외처리 : " + ex);
		} finally {
			try {
				if (rs != null) 
					rs.close();							
	...
	public void updateBoard(BoardDTO board) {
		...
		try {
			...
			System.out.println("updateBoard() 예외처리 : " + ex);
		} finally {
			try {										
				if (pstmt != null) 
					pstmt.close();				
